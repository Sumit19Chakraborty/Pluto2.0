  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What you will learn from <span className="text-gradient">Souvik Trading?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-mono">
          ...
          no further than Souvik Trading, the premier programming community
          dedicated to helping new programmers achieve their goals and reach
          their full potential.
          <br />
          <br />
          As the founder and CEO of Souvik Trading, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created Souvik Trading &ndash; to provide new
          ...
          <br />
          <br />
          At Souvik Trading, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Souvik Trading is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Souvik Trading by your side, there&apos;s nothing standing between
          ...
          <br />
          <br />
          So what are you waiting for? Join the Souvik Trading family today and
        ...
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Souvik Trading
        </h5>
        <br />
        <br />
        <br />
